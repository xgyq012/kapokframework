...
!function(window, $) {
    ...
    Main.prototype.ready = function(callback, params, o) {
        ...
        var resourceAjax = _createAjaxObject(options.cacheOptions.resource),
        	meshAjax = _createAjaxObject(options.cacheOptions.mesh),
        	userMeshAjax = _createAjaxObject(options.cacheOptions.userMesh),
        	dictAjax = _createAjaxObject(options.cacheOptions.dict);

	    $.when(resourceAjax, meshAjax, userMeshAjax, dictAjax).done(function() {
