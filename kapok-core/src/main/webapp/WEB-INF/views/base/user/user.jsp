 		...
 		$('#dg_userRoles').datagrid({
			...
			onDblClickRow: _onUserRolesDblClickRow,
 			columns: [[
				...
				{field: 'roleCode', title: '角色编码', width: 100, halign: 'center'},
				{field: 'roleName', title: '角色名称', width: 100, halign: 'center'},
				{field: 'roleType', title: '角色类型', width: 100, halign: 'center'},
				{field: 'roleDesc', title: '角色描述', width: 100, halign: 'center'},
				{
					field: 'isGranted',
					title: '是否可授出',
					width: 80,
				...
				{field: 'remark',  title: '备注', width: 100, halign: 'center', editor:'text'}
 			]]
 		});	
