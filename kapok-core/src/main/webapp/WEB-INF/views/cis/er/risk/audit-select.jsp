...
<div class="g-layout">
	...
	<div id="toolbar" class="dialog-button">
		<a id="confirm" class="easyui-linkbutton g-button" onclick="saveAudit();"><i class="fa fa-check"></i>通过</a>
		<a id="cancel" class="easyui-linkbutton g-button" onclick="window.actions.cancel(cancelAudit());"><i class="fa fa-times"></i>不通过</a>
	</div>
</div>
...
// 	  $("#riskStatus").val(params.riskStatus);
  ...
  /**
	...
	*/
	function saveAudit(){
	  $("input[name='riskStatus']").val('audit');
