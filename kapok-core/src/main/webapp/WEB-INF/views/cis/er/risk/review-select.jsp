...
<div class="g-layout">
	...
	<div id="toolbar" class="dialog-button">
		<a id="confirm" class="easyui-linkbutton g-button" onclick="saveReview();"><i class="fa fa-check"></i>通过</a>
		<a id="cancel" class="easyui-linkbutton g-button" onclick="window.actions.cancel(cancelReview());"><i class="fa fa-times"></i>不通过</a>
	</div>
</div>
...
// 	  $("#riskStatus").val(params.riskStatus);
  ...
  /**
	...
	*/
	function saveReview(){
	  $("input[name='riskStatus']").val('review');
