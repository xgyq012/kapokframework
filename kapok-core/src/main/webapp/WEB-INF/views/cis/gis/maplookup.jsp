...
<body>
    <div id="mainTab" class="easyui-panel" style="width:100%;height:100%; margin: 0; padding: 10px 0 0 0;">
    		...
    		<table  cellpadding="0" cellspacing="0">
     			...
     			<tr>
     			    <td class="form-cell-4" colspan="4">
     					   ...
     					   <div id="addFile"></div>
	     				   <input id="docName" name="fileName" class="easyui-validatebox form-control" readonly="readonly" style="width: 500px">
	     			</td>      			
     			</tr>      						     			    			 			
     		</table>
     	</form>	
     	
        <div id="toolbar" style="text-align: right; padding-right: 125px; ">
...
var yingjiShijianId = parent.$("#baseForm #yingjiShijianId").val();
var uploadBtn;
