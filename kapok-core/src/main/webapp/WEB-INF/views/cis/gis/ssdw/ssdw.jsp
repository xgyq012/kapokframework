				    ...
				    <table class="g-form" class="formCls" cellpadding="0" cellspacing="0">
						<tr>	
							<td class="form-cell-1">
	            				...
	            				<input  id="meshId" name="q_meshId_EQ"  />
	            			</td>
							<td class="form-cell-1">
		    				...
		    				<td class="form-cell-1">
		    					...
		    					<input dictCode="facilityType" name="q_facilityTypeName_EQ"
			...
			$("#listGrid").datagrid({
				...
				onClickRow : function(rowIndex, rowData) {
					if(rowData.lon && rowData.lat){
						var p = new BMap.Point(rowData.lon, rowData.lat)
						map.setCenter(p);
					}
				},
					...
					if(rows){
						$.each(rows,function (i,n){
							 ...
							 $.each(rows,function (i,n){
								...
								MyMap.addMarker(n.lon,n.lat,n.facilityName,url,true)
							});
						});
					}else{
