				    ...
				    <table class="g-form" class="formCls" cellpadding="0" cellspacing="0">
						 <tr>	
							<td class="form-cell-1">
	            				...
	            				<input class="easyui-validatebox form-control" name="q_e.EMEPLACE_NAME_LIKE"  />
	            			</td>
...
var MyMap = {
		...
		init : function (){
			...
			var defaultPoint = new BMap.Point(116.404, 39.915);  // 创建点坐标  
					...
					if(rows){
						$.each(rows,function (i,n){
							 ...
							 $.each(rows,function (i,n){
								...
								MyMap.addMarker(n.lon,n.lat,n.emePlaceName,url,true);
							});
						});
					}else{
