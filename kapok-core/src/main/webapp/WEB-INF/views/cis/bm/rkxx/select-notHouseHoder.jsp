...
var thisUiConfig = {
		...
		ctx : '${ctx}',
		searchUrl : '${ctx}/householder/searchNotHousehold',
		url : "householder",
 ...
 $(function (){
	 ...
	 $("#listGrid").datagrid({
			...
			onLoadSuccess : function (data){
				 var existsArray =  window.params.householderArray ;
				 $.extend(true,hoderList,existsArray);
				 if(data){
					 var listGrid = $("#listGrid");
					 $.each(data.rows,function (index,n){
						 $.each(hoderList,function (j,r){
							 if(r.householderId==n.householderId){
			...
			onCheck:function (index,row){
				...
				hoderList[row.householderId] = row
				
			},
			onUncheck:function (index,row){
				 delete hoderList[row.householderId];
			},
...
function  sub(){
	 window.actions.confirm(hoderList);
}
