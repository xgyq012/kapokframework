						...
						<tbody>
							<tr>	
								<td class="form-cell-1">
		            				...
		            				<input name="q_accountPer_LIKE"  class="easyui-validatebox form-control"  />
		            			</td>
								<td class="form-cell-1">
		            				<label class="form-label">责任单位</label>
		            				<input name="q_accountUnit_LIKE" class="easyui-validatebox form-control"  /></td>
								<td class="form-cell-1">
		            				<label class="form-label">处理类型</label>
		            				<input name="q_handleType_LIKE" class="easyui-validatebox form-control"  />
		            			</td>
       ...
       <div id="minute" data-options="disabled:true"  title="详细"   >
      	...
      	<fieldset>
    		...
    		<form id="baseForm"  action="">
	    		<!-- 隐藏属性 -->
	    		<input id="petitionId" name="petitionId" type="hidden" />
    		...
    		<table class="g-form" cellpadding="0" cellspacing="0" >
     			<tr>
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">上访人员姓名</label>
     					<input required="required" class="easyui-validatebox form-control"  name="petitionName" />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">责任单位</label>
     					<input  required="required"  name="accountUnit" class="easyui-validatebox form-control"   />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">责任人</label>
     					<input  name="accountPer" class="easyui-validatebox form-control"   />
     				</td>
     			</tr>
     			
    		   <tr>
     				<td class="form-cell-1">
	            		<label class="form-label">分包领导</label>
     					<input  name="leadership"   class="easyui-validatebox form-control" />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">处理类型</label>
     					<input  name="handleType" class="easyui-validatebox form-control" />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">时间</label>
     					 <input  name="time" class="easyui-datebox  form-control" data-options="editable:false" style="width:${comboboxWidth};height:${comboboxHeight}px" />
     				</td>
     			</tr>
     			
     			 <tr>
     				<td class="form-cell-4" colspan="4">
	            		<label class="form-label">反应主要问题</label>
     					<textarea required="required" class="easyui-validatebox form-control" name="mainProblem" rows="5"></textarea>
     				</td>
     			</tr>
...
var thisUiConfig = {
	...
	ctx : "${ctx}",
	url : "petition",
	id : "#petitionId",    //表单中主键字段对应的控件的Id属性值
	idName:"petitionId",
	tableList : "#listGrid",
	getId : function (){
...
var baseInfo =  {
	...
	del:function (){
		...
		$.messager.confirm("温馨提示", "确定删除责任单位为【"+row.accountUnit+"】记录?",
			function(r) {
				if (r) {
