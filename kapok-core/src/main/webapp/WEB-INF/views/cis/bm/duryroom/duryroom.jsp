					...
					<table class="g-form" cellpadding="0" cellspacing="0" >
						<tr>	
							<td class="form-cell-1">
	            				<label class="form-label">值班室名称</label>
	            				<input name="q_duryroomName_LIKE" class="easyui-validatebox form-control"     /></td>
							<td class="form-cell-1">
	            				<label class="form-label">值班室负责人</label>
								 <input name="q_duryroomDirector_LIKE" class="easyui-validatebox form-control"     /></td>
      ...
      <div id="minute" data-options="disabled:true"  title="详细" >
       ...
       <fieldset>
    		...
    		<form id="baseForm"  action="">
	    		<!-- 隐藏属性 -->
	    		<input id="duryroomId" name="duryroomId" type="hidden" />
    		...
    		<table class="g-form" cellpadding="0" cellspacing="0" >
     			...
     			<tr>
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">值班室名称</label>
     					<input name="duryroomName" class="easyui-validatebox form-control"  required="required"   />
     				</td>
     				<td class="form-cell-1">
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">值班室负责人</label>
     					<input name="duryroomDirector" class="easyui-validatebox form-control"     />
     				</td>
     			</tr>
     			...
     			<tr>
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">电子监控</label>
     					<input dictCode="IsIntall" name="monitoring" class="easyui-combobox form-control"
     			...
     			<tr>
     				<td class="form-cell-4" colspan="4">
     					...
     					<textarea name="fireproofing" class="easyui-validatebox form-control"  rows="5"  ></textarea>
     				</td>
     			</tr>
     			...
     			<tr>
     				<td class="form-cell-4" colspan="4">
     					...
     					<textarea name="preventiveMeasures" class="easyui-validatebox form-control"  rows="5"  ></textarea>
     				</td>
     			</tr>
     			<tr>
					<td class="form-cell-1">
...
var thisUiConfig = {
	...
	ctx : "${ctx}",
	url : "duryroom",
	id : "#duryroomId",    //表单中主键字段对应的控件的Id属性值
	idName:"duryroomId",
	tableList : "#listGrid",
	getId : function (){
...
var baseInfo =  {
	...
	del:function (){
		...
		$.messager.confirm("温馨提示", "确定删除值班室名称为【"+row.duryroomName+"】记录?",
			function(r) {
				if (r) {
					publicFormControl.ajax({
