				...
				<form id="queryForm" class="formCls" method="post">
					<table class="g-form" cellpadding="0" cellspacing="0" >
						<tr>	
							...
							<td class="form-cell-1">
	            				<label class="form-label">治安负责人</label>
								<input name="q_securityDirector_LIKE"  class="easyui-validatebox form-control"  /></td>
							<td class="form-cell-1">
	            				<label class="form-label">检查人</label>
								<input name="q_rummager_LIKE"  class="easyui-validatebox form-control"  />
							</td>
      ...
      <div id="minute" data-options="disabled:true"  title="详细" >
       ...
       <fieldset>
    		...
    		<form id="baseForm"  action="">
	    		<!-- 隐藏属性 -->
	    		<input id="pusecurityId" name="pusecurityId" type="hidden" />
    		...
    		<table class="g-form" cellpadding="0" cellspacing="0" >
     			...
     			<tr>
     				...
     				<td class="form-cell-2" colspan="2">
	            		<label class="form-label">单位地址</label>
     					<input name="unitsAddress" class="easyui-validatebox form-control"    />
     				</td>
     			...
     			<tr>
     				<td class="form-cell-1">
	            		<label class="form-label">治安负责人</label>
     					<input  name="securityDirector" class="easyui-validatebox form-control"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">单位治安负责人电话</label>
     					<input  name="directorPhone" class="easyui-validatebox form-control"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">治安员</label>
     					<input  name="peaceOfficer" class="easyui-validatebox form-control"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">治安员电话</label>
     					<input  name="officerPhone" class="easyui-validatebox form-control"    />
     				</td>
     			</tr>
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">检查人</label>
     					<input  name="rummager" class="easyui-validatebox form-control"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">联系电话</label>
     					<input  name="rummagerPhone" class="easyui-validatebox form-control"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">检查日期</label>
     					<input name="edttime" class="easyui-datebox form-control" data-options="editable:false"
     			...
     			<tr>
     				<td class="form-cell-4" colspan="4">
     					<label class="form-label">治安隐患</label>
     					<textarea name="securityHidden" class="easyui-validatebox form-control"  rows="5"  ></textarea>
     				</td>
     			</tr>
     			...
     			<tr>
     				<td class="form-cell-4" colspan="4">
     					<label class="form-label">整改情况</label>
     					<textarea name="situation" class="easyui-validatebox form-control"  rows="5"  ></textarea>
     				</td>
     			</tr>
...
var thisUiConfig = {
	...
	ctx : "${ctx}",
	url : "puSecurity",
	id : "#pusecurityId",    //表单中主键字段对应的控件的Id属性值
	idName:"pusecurityId",
	tableList : "#listGrid",
	getId : function (){
