					...
					<table class="g-form" cellpadding="0" cellspacing="0" >
						<tr>	
							<td class="form-cell-1">
	            				<label class="form-label">摄像头位置</label>
	            				<input name="q_camerPos_LIKE"  class="easyui-validatebox form-control"
	            						data-options="editable:false"
										style="width:${comboboxWidth};height:${comboboxHeight}px"   /></td>
							<td class="form-cell-1">
	            				<label class="form-label">摄像头个数</label>
								<input name="q_camerNum_EQ"  class="easyui-validatebox form-control"   /></td>
								<td class="form-cell-1">
	            				<label class="form-label">时间</label>
								<input name="q_time_EQ"   class="easyui-datebox form-control" 
										data-options="editable:false"
										style="width:${comboboxWidth};height:${comboboxHeight}px"    /></td>
      ...
      <div id="minute" data-options="disabled:true"  title="详细" >
       ...
       <fieldset>
    		...
    		<form id="baseForm"  action="">
	    		<!-- 隐藏属性 -->
	    		<input id="safetyId" name="safetyId" type="hidden" />
    		...
    		<table class="g-form" cellpadding="0" cellspacing="0" >
     			...
     			<tr>
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">摄像头个数</label>
     					<input name="camerNum" class="easyui-validatebox form-control" validType="checkNumber"  required="required"  />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">时间</label>
     					<input  name="time" class="easyui-datebox form-control" data-options="editable:false"
     			...
     			<tr>
     				<td class="form-cell-4" colspan="4">
     					<label class="form-label">摄像头位置</label>
     					<textarea required="required" name="camerPos" class="easyui-validatebox form-control" ></textarea>
     				</td>
     			</tr>
...
var thisUiConfig = {
	...
	ctx : "${ctx}",
	url : "safety",
	id : "#safetyId",    //表单中主键字段对应的控件的Id属性值
	idName:"safetyId",
	tableList : "#listGrid",
	getId : function (){
