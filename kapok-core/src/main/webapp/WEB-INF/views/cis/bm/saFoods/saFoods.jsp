...
<div id="mainTab" class="easyui-tabs  g-container g-tabs1" data-options="fit:true,border:false" >
     ...
     <div title="列表" style="position:relative;">
					...
					<table class="g-form" cellpadding="0" cellspacing="0" >
						<tr>	
							<td class="form-cell-1">
	            				...
	            				<input name="q_goodsName_LIKE"  class="easyui-validatebox form-control"  /></td>
							<td class="form-cell-1">
	            				<label class="form-label">经销商名称</label>
								<input name="q_dealerName_LIKE"  class="easyui-validatebox form-control"  /></td>
								
							<td class="form-cell-1">
	            				<label class="form-label">商品类型</label>
								<input  dictCode="ProductTypes" name="q_goodsType_EQ" class="easyui-combobox form-control"
      ...
      <div id="minute" data-options="disabled:true"  title="详细" >
       ...
       <fieldset>
			<legend>食品安全信息</legend>
			
    		<form id="baseForm"  action="">
	    		<!-- 隐藏属性 -->
	    		<input id="safoodsId" name="safoodsId" type="hidden" />
    		...
    		<table class="g-form" cellpadding="0" cellspacing="0" >
     			...
     			<tr>
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">商品名称</label>
     					<input name="goodsName" class="easyui-validatebox form-control"     />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">商品类型</label>
     					<input  dictCode="ProductTypes" name="goodsType" class="easyui-combobox form-control"
	     						style="width:${comboboxWidth};height:${comboboxHeight}px"
								data-options="
							    	editable:false,
							    	panelHeight:'auto',
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">生产企业名称</label>
     					<input  name="enterpriseName" class="easyui-validatebox form-control"    />
     				</td>
     			</tr>
     			...
     			<tr>
     				<td class="form-cell-1">
	            		<label class="form-label">经销商名称</label>
     					<input  name="dealerName" class="easyui-validatebox form-control"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">经销商营业执照</label>
     					<input  name="dealerPermit" class="easyui-validatebox form-control"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">商品保质期</label>
     					<input name="expirationDate" class="easyui-datebox form-control" 
...
var thisUiConfig = {
	...
	ctx : "${ctx}",
	url : "foodSafety",
	id : "#safoodsId",    //表单中主键字段对应的控件的Id属性值
	idName:"safoodsId",
	tableList : "#listGrid",
	getId : function (){
...
var baseInfo =  {
	...
	del:function (){
		...
		$.messager.confirm("温馨提示", "确定删除食品名称为【"+row.goodsName+"】记录?",
			function(r) {
				if (r) {
					publicFormControl.ajax({
		...
		$("#listGrid").datagrid({
			...
			columns : [ [ {
				...
				formatter : function (value,row,index){
					...
					return publicAttr.getDictText("ProductTypes",value);
				}
			},{
