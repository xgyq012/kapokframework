    ...
    <div id="mainTab" class="easyui-tabs g-container g-tabs1" data-options="fit:true,border:false">
        ...
        <div title="详细" data-options="disabled:true" >
            ...
            <form id="sbxx" infoName="sbxx"  action="${ctx}/socialinfo/save">
                <input id="socialId" name="socialId" type="hidden">
...
<script type="text/javascript">
    ...
    var thisUiConfig = {
        main : window.main,
        ctx : '${ctx}',
        searchUrl : '${ctx}/householder/searchSocialinfoHolder'
    }
    ...
    function del(){
        ...
        $.messager.confirm("温馨提示", "确定删除【"+householderName+"】的社保信息?",
            function(r) {
                if (r) {
                    publicFormControl.ajax({
                        url : thisUiConfig.ctx + "/socialinfo/del/"+ householderId,
                        type: "POST"
                    },function (data){
    ...
    function save(){
        ...
        if($("#sbxx").form("validate")) {
            var data = getFormData("#sbxx");
            data['householderId'] =  $("#householderId").val();
            publicFormControl.ajax({
                type: "POST",
                url : thisUiConfig.ctx + "/socialinfo/save",
                data: data
            },function (result){
                $("#sbxx").form("load",result.row);
    ...
    function socialinfo(holderId){
        ...
        $.ajax({
            type : "POST",
            url : thisUiConfig.ctx + "/socialinfo/getInfoByHouseHolder/"+holderId ,
