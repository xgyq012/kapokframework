                    ...
                    <table class="g-form" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="form-cell-1">
                                ...
                                <input name="q_cultivateName_LIKE" class="easyui-validatebox form-control"/>
                            </td>
                            <td class="form-cell-1">
                                <label class="form-label">培训主题</label>
                                <input name="q_title_LIKE" class="easyui-validatebox form-control"/></td>
                            <td class="form-cell-1">
                                <label class="form-label">讲师姓名</label>
                                <input name="q_lecturer_LIKE" class="easyui-validatebox form-control"/>
                            </td>
        ...
        <div id="minute" data-options="disabled:true" title="详细">
            ...
            <fieldset>
                ...
                <form id="baseForm" action="">
                    <!-- 隐藏属性 -->
                    <input id="cultivateId" name="cultivateId" type="hidden"/>
                    ...
                    <table class="g-form" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="form-cell-1">
                                ...
                                <input dictCode="Gender" name="cultivateGender" class="easyui-combobox form-control"
                            ...
                            <td class="form-cell-1">
                                ...
                                <input name="idNumber" class="easyui-validatebox form-control"
                        ...
                        <tr>
                            ...
                            <td class="form-cell-1">
                                ...
                                <input name="lecturer" class="easyui-validatebox form-control"/>
                            </td>
                            <td class="form-cell-1">
                                <label title="讲师联系电话" class="form-label">讲师联系电话</label>
                                <input name="lecturerPhone" class="easyui-validatebox form-control"/>
                            </td>
                            <td class="form-cell-1">
                                <label class="form-label">培训主题</label>
                        ...
                        <tr>
                            <td class="form-cell-1">
                                ...
                                <input name="cultivateTime" class="easyui-datebox form-control"
                                       style="width:${comboboxWidth};height:${comboboxHeight}px"
                        ...
                        <tr>
                            <td class="form-cell-4" colspan="4">
                                ...
                                <textarea name="cultivateContent" class="easyui-validatebox form-control"
                                          rows="8"></textarea>
                            </td>
                        </tr>
                    </table>
...
<script type="text/javascript">
    ...
    var thisUiConfig = {
        ...
        ctx: "${ctx}",
        url: "cultivate",
        id: "#cultivateId",    //表单中主键字段对应的控件的Id属性值
        idName: "cultivateId",
        tableList: "#listGrid",
        getId: function () {
    ...
    var baseInfo = {
        ...
        del: function () {
            ...
            $.messager.confirm("温馨提示", "确定删除姓名为【" + ($("input[name='cultivateName']").val() || row.cultivateName) + "】的培训记录?",
                    function (r) {
                        if (r) {
