...
<div id="mainTab"  class="easyui-tabs  g-container g-tabs1" data-options="fit:true,border:false">
					...
					<table class="g-form" cellpadding="0" cellspacing="0" >
						...
						<tr>	
							<td class="form-cell-1">
	            				...
	            				<input  class="easyui-validatebox form-control" name="q_judName_LIKE" />
	            			</td>
							<td class="form-cell-1">
	            				<label class="form-label">受理情况</label>
	            				<input dictCode="judicalSituation" name="q_acceptSituation_EQ" class="easyui-combobox  form-control"
							...
							<td class="form-cell-1">
	            				<label class="form-label">调解类型</label>
	            				<input dictCode="judicalType"  name="q_mediationType_EQ"  class="easyui-combobox  form-control"
									style="width:${comboboxWidth};height:${comboboxHeight}px"
									data-options="
 								    	editable:false,
 								    	panelHeight:'auto',
     ...
     <div id="minute" data-options="disabled:true"  title="详细"   >
    		...
    		<form id="baseForm"  action="">
	    		<!-- 隐藏属性 -->
	    		<input id="judicialId" name="judicialId" type="hidden" />
    		...
    		<table class="g-form" cellpadding="0" cellspacing="0" >
    			<tbody>
     			<tr>
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">当事人</label>
     					<input required="required" class="easyui-validatebox form-control"  name="judName"  type="text"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">联系电话</label>
     					<input  class="easyui-validatebox form-control"   required="required"  name="contactNumber"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">录入时间</label>
     					<input data-options="editable:false" class="easyui-datebox form-control"  name="entryTime"  style="width:${comboboxWidth};height:${comboboxHeight}px"  />
     				</td>
     			</tr>
     			
     			<tr>
     				<td class="form-cell-1">
	            		<label class="form-label">录入人姓名</label>
     					<input  class="easyui-validatebox form-control"   name="recordName"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">结束时间</label>
     					<input data-options="editable:false" name="overTime" class="easyui-datebox form-control" style="width:${comboboxWidth};height:${comboboxHeight}px"  />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">受理情况</label>
     					<input dictCode="judicalSituation" name="acceptSituation" class="easyui-combobox form-control"
     								style="width:${comboboxWidth};height:${comboboxHeight}px"
									data-options="
 								    	editable:false,
 								    	panelHeight:'auto',
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">调解类型</label>
     					<input dictCode="judicalType" name="mediationType" class="easyui-combobox form-control"
									style="width:${comboboxWidth};height:${comboboxHeight}px"
									data-options="
 								    	editable:false,
 								    	panelHeight:'auto',
    		   ...
    		   <tr>
     				<td class="form-cell-1">
	            		<label class="form-label">事件标题</label>
     					<input required="required" class="easyui-validatebox form-control"  name="incidentTitle"  type="text"    />
     				</td>
     			</tr>
     		 	...
     		 	<tr>
     				<td class="form-cell-4" colspan="4">
	            		<label class="form-label">事件描述</label>
     					<textarea name="eventDescription" required="required" class="easyui-validatebox form-control"  rows="10" ></textarea>
     				</td>
     			</tr>
     			
     			 <tr>
     				<td class="form-cell-4" colspan="4" >
	            		<label class="form-label">结案描述</label>
     					<textarea name="caseDescription"  class="easyui-validatebox form-control"  rows="10" ></textarea>
     				</td>
     			</tr>
     			 </tbody>
     		</table>
...
var thisUiConfig = {
	...
	ctx : "${ctx}",
	url : "judical",
	id : "#judicialId",    //表单中主键字段对应的控件的Id属性值
	idName:"judicialId",
	tableList : "#listGrid",
	getId : function (){
...
var baseInfo =  {
	...
	del:function (){
		...
		$.messager.confirm("温馨提示", "确定删除事件标题为【"+row.incidentTitle+"】记录?",
		...
		$("#listGrid").datagrid({
			...
			columns : [ [ {
				...
				formatter : function (value,row,index){
					...
					return publicAttr.getDictText("judicalSituation",value);
				}
			},{
				field:"mediationType",
				title:"调解类型",
				...
				formatter : function (value,row,index){
					...
					return publicAttr.getDictText("judicalType",value);
				}
			},{
				field:"judName",
				title:"当事人",
