...
<div id="mainTab" class="easyui-tabs  g-container g-tabs1" data-options="fit:true,border:false" >
     ...
     <div title="列表" style="position:relative;">
					...
					<table class="g-form" cellpadding="0" cellspacing="0" >
						<tr>	
							<td class="form-cell-1">
	            				...
	            				<input name="q_companyName_LIKE"  class="easyui-validatebox form-control"
	            						data-options="editable:false"
										style="width:${comboboxWidth};height:${comboboxHeight}px"   /></td>
							<td class="form-cell-1">
	            				<label class="form-label">安全制度</label>
            					<input dictCode="YesOrNo" name="q_securitySystem_LIKE" class="easyui-combobox form-control"
      ...
      <div id="minute" data-options="disabled:true"  title="详细" >
       ...
       <fieldset>
			<legend>企业安全信息</legend>
			
    		<form id="baseForm"  action="">
	    		<!-- 隐藏属性 -->
	    		<input id="saenterpriseId" name="saenterpriseId" type="hidden" />
    		...
    		<table class="g-form" cellpadding="0" cellspacing="0" >
     			...
     			<tr>
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">企业名称</label>
     					<input name="companyName" class="easyui-validatebox form-control" required="required"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">法人</label>
     					<input name="corp" class="easyui-validatebox form-control"  required="required"     />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">安全负责人</label>
     					<input  name="safetyDirector" class="easyui-validatebox form-control"    />
     				</td>
     			</tr>
     			...
     			<tr>
     				...
     				<td class="form-cell-1">
	            		<label class="form-label">安全员</label>
     					<input  name="safetyOfficer" class="easyui-validatebox form-control"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">安全员电话</label>
     					<input  name="officerPhone" class="easyui-validatebox form-control"    />
     				</td>
     				<td class="form-cell-1">
	            		<label class="form-label">安全制度是否落实</label>
     					<input dictCode="YesOrNo" name="securitySystem" class="easyui-combobox form-control"
     								style="width:${comboboxWidth};height:${comboboxHeight}px"
									data-options="
 								    	editable:false,
 								    	panelHeight:'auto',
...
var thisUiConfig = {
	main : window.main,
	ctx : "${ctx}",
	url : "enterpriseSafety",
	id : "#saenterpriseId",    //表单中主键字段对应的控件的Id属性值
	idName:"saenterpriseId",
	tableList : "#listGrid",
	getId : function (){
...
var baseInfo =  {
	...
	del:function (){
		...
		$.messager.confirm("温馨提示", "确定删除企业名称为【"+row.companyName+"】记录?",
			function(r) {
				if (r) {
					publicFormControl.ajax({
