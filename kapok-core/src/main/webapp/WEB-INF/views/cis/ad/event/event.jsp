					...
					<table  class="g-form" cellpadding="0" cellspacing="0">
						<tr>	
							<td class="form-cell-1">
	            				...
	            				<input  id="meshId" name="q_r.BACKLOG_ID_IN"  />
	            			</td>
							<td class="form-cell-1">
								<label class="form-label">登记日期</label>
                                <input name="q_r.create_Time_GTE_Date" class="easyui-datebox form-control"
                                       style="width:${comboboxWidth};height:${comboboxHeight}px"
                                       data-options="editable:false">
							</td>
	            			<td class="form-cell-1">
                                <label class="form-label"> ~ </label>
                                <input name="q_r.create_Time_LTE_Date" class="easyui-datebox form-control"
                                       style="width:${comboboxWidth};height:${comboboxHeight}px"
                                       data-options="editable:false">
                            </td>
...
var tableInfo =  {
	...
	init : function (){
		...
		$("#listGrid").datagrid({
			...
			url : thisUiConfig.ctx +"/basicData/eventSearch",
			columns : [[{
				field : "orgId",
				title : "所属机构",
				width : 150,
	...
	getQueryFormData : function (formId){
		...
		if(meshIds){
			var q_mesh = data['q_r.BACKLOG_ID_IN'];
			data['q_r.BACKLOG_ID_IN'] = q_mesh || meshIds;
		}
		return data;
	}
};
