					...
					<table  class="g-form" cellpadding="0" cellspacing="0">
						<tr>	
							<td class="form-cell-1">
	            				...
	            				<!-- <input  id="leixingName" name="q_name_EQ"  /> --> 
	            				<input id="q_yjsjlxId_EQ" name="q_h.YJSJLX_ID_EQ" type="hidden"/>
...
var tableInfo =  {
	...
	init : function (){
		...
		$("#listGrid").datagrid({
			...
			url : thisUiConfig.ctx +"/basicData/emergencySearch",
			columns : [[{
				field : "name",
				title : "事件类型",
				width : 150,
	...
	getQueryFormData : function (formId){
		...
		if(meshIds){
			var q_mesh = data['q_h.YJSJLX_ID_EQ'];
			data['q_h.YJSJLX_ID_EQ'] = q_mesh || meshIds;
		} */
		var data =  getFormData(formId) || {};
		...
		contentWindow:{
			...
			actions : {
				confirm : function(data) {
					$("#queryFullName").lookup("setTxt", data.leixingName);
