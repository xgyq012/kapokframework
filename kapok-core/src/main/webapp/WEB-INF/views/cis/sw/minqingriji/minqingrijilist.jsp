	...
	<div id="query">
		<form id="queryForm" class="formCls" method="post">
			<table>
				<tr>	
					<td>日记标题</td>
					<td><input id="orgName_LIKE" name="q_title_LIKE" type="text" /></td>
					<td>作者</td>
					<td><input id="realname_LIKE" name="" type="text" /></td>
					<td>发布时间</td>
					<td><input name="q_submitTime_LT" type="text" class="easyui-datebox"  data-options="editable:false,formatter:formatterDate"   /></td>
...
<div id="mainTab" class="easyui-tabs" style="width:100%;height:100%;padding-bottom: 110px;">
     ...
     <div title="列表" style="padding:5px;height: 100%">
         <div id="list" style="overflow: auto;height: 100%"">
			<table title="应急事件信息列表" id="listGrid" style="height:100%;"></table>
		</div>
     </div>
     ...
     <fieldset style="width:95%;">
    		...
    		<input type="hidden" id="minqingRijiId" name="minqingRijiId">
    		<input id="createrId" name="createrId" type="hidden" />
			<input id="createTime" name="createTime" type="hidden" />
    		<table>
     			<tr>
     				<td>日记标题</td>
     				<td class="tdInput"><input type="text" name="title" class="easyui-validatebox" required="required"  /></td>
     			</tr>
     			<tr>
     				<td>日记内容</td>
     				<td class="tdInput"><textarea name="body" rows="10" cols="1000"></textarea></td>
     			</tr>
     			<tr>
     				<td>是否发布日记</td>
     				<td class="tdInput"><input name="rijiStatus" class="easyui-combobox"
									data-options="
 								    	editable:false,
 								    	panelHeight:'auto',
 								    	valueField:'dictCode',
 								    	textField:'dictName',
 								    	url:'${ctx}/dict/getdict/rijiStatus'"></td>
     			</tr>
     		</table>
     		</form>
     	</fieldset>
...
var thisUiConfig = {
	ctx : "${ctx}",
	url : "minqingriji",
	id : "#minqingRijiId",    //表单中主键字段对应的控件的Id属性值
	idName:"minqingRijiId",
	tableList : "#listGrid",
	queryForm : "#queryForm",
	mainTab : "#mainTab",
	getId : function (){
