		    ...
		    <form id="queryForm" class="formCls" method="post">
			  <table style="padding: 5px 0 6px 0;">
				<tr>	
					<td class="aaaa">
			            <label>应急预案名称</label>
			            <input id="q_name_LIKE" name="q_name_LIKE" style="height: 25px; margin: 0;">
			        </td>
					<td class="aaaa">
			            <label>应急事件类型</label>
					...
					<td class="aaaa">
						<a href="javascript:void(0);" onclick="tableInfo.query();"
							class="easyui-linkbutton g-button"><i class="fa fa-search"></i>查询</a>
						<a href="javascript:void(0);" onclick="clearQueryForm('#queryForm');"
							class="easyui-linkbutton g-button"><i class="fa fa-reply"></i>重置</a>
					</td>				
				</tr>
			   </table>
		     </form>
	     </div>
		 <table title="应急预案列表" id="listGrid" style="height: 300px;"></table>
	</div>
