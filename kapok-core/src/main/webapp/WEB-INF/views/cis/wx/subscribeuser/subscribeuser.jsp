                    ...
                    <table  class="g-form" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td class="form-cell-1">
                                ...
                                <input name="q_subscribeNickname_LIKE" class="easyui-validatebox form-control"  /></td>
                ...
                <table class="g-form" cellpadding="0" cellspacing="0" >
                    ...
                    <tr>
                        <td colspan="4" class="form-cell-4">
                            ...
                            <textarea name="replyContent" class="easyui-validatebox form-control" rows="3" ></textarea>
                        </td>
                    </tr>
    ...
    var tableInfo =  {
        ...
        init : function (){
            ...
            $("#listGrid").datagrid({
                ...
                columns : [ [ {
                    field : "subscribeUserId",
                    hidden:true
                },{
                    field : "subscribeNickname",
                    title : "用户的昵称",
                    width : 200,
                    halign:'center',
                    align:'left'
                    ...
                    formatter : function (value,row,index){
                        ...
                        return publicAttr.getDictText("WX_Gender",value);
                    }
                },{
                    field : "subscribeProvince",
                    title : "所在省份",
                    width : 200,
                    halign:'center',
                    align:'left'
