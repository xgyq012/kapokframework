                ...
                <table class="g-form" cellpadding="0" cellspacing="0" >
                    ...
                    <tr>
                        ...
                        <td class="form-cell-2" colspan="2">
                            <label class="form-label">任务名称</label>
                            <input name="taskName" class="easyui-validatebox form-control" />
                        </td>

                        <td class="form-cell-1">
                            <label class="form-label">发送类型</label>
                            <input dictCode="WX_TASK_TYPE" name="sendType" class="easyui-combobox form-control"
                        ...
                        <td class="form-cell-1">
                            ...
                            <input id="sendStatus" name="sendStatus" class="easyui-validatebox form-control" disabled  />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="form-cell-2" colspan="2">
                            ...
                            <input id="sendTime" name="sendTime" class="easyui-validatebox form-control" disabled />
                        </td>
                    </tr>
            ...
            $("#listGrid").datagrid({
                ...
                columns : [ [ {
                    ...
                    formatter : function (value,row,index){
                        ...
                        return publicAttr.getDictText("WX_TASK_TYPE",value);
                    }
                },{
                    field:"sendStatus",
                    title:"发送状态",
                    ...
                    formatter : function (value,row,index){
                        ...
                        return publicAttr.getDictText("WX_SEND_STATUS",value);
                    }
                },{
                    field:"sendNum",
                    title:"发送条数",
