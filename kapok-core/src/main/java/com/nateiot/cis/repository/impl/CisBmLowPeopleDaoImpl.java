...
import com.nateiot.cis.repository.CisBmLowPeopleDaoPlus;
import com.nateiot.core.common.persistence.SearchFilter;
import com.nateiot.core.repository.impl.BaseDaoImpl;

public class CisBmLowPeopleDaoImpl extends BaseDaoImpl implements CisBmLowPeopleDaoPlus {
	...
	public Page<Map<String, Object>> getLowPeopleHouseHolder(Map<String, SearchFilter> conditions, Pageable pageable){
		...
		String sqlString = " SELECT "
				    ...
				    +" FROM "
				        ...
				        +" right JOIN CIS_BM_LOW_PEOPLE l ON l.HOUSEHOLDER_ID = h.HOUSEHOLDER_ID "
				    +" where  h.del_sign <> 'Y' " ;
