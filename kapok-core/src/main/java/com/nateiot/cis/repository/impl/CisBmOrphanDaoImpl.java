...
import com.nateiot.cis.repository.CisBmOrphanDaoPlus;
import com.nateiot.core.common.persistence.SearchFilter;
import com.nateiot.core.repository.impl.BaseDaoImpl;

public class CisBmOrphanDaoImpl extends BaseDaoImpl implements CisBmOrphanDaoPlus {
...
public Page<Map<String, Object>> getOrphanHouseHolder(Map<String, SearchFilter> conditions, Pageable pageable){
		...
		String sqlString = " SELECT "
				    ...
				    +" FROM "
				        ...
				        +" right JOIN CIS_BM_ORPHAN l ON l.HOUSEHOLDER_ID = h.HOUSEHOLDER_ID "
				    +" where  h.del_sign <> 'Y' " ;
