...
import com.nateiot.cis.repository.CisBmOldPeopleHDaoPlus;
import com.nateiot.core.common.persistence.SearchFilter;
import com.nateiot.core.repository.impl.BaseDaoImpl;

public class CisBmOldPeopleHDaoImpl extends BaseDaoImpl implements CisBmOldPeopleHDaoPlus{
	...
	public Page<Map<String, Object>> getOldPeoHouseHolder(Map<String, SearchFilter> conditions, Pageable pageable){
		...
		String sqlString = " SELECT "
				    ...
				    +" FROM "
				        ...
				        +" right JOIN CIS_BM_OLD_PEOPLE_H l ON l.HOUSEHOLDER_ID = h.HOUSEHOLDER_ID "
				    +" where  h.del_sign <> 'Y' " ;
