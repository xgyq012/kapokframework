...
import com.nateiot.cis.repository.CisBmWbgyDaoPlus;
import com.nateiot.core.common.persistence.SearchFilter;
import com.nateiot.core.repository.impl.BaseDaoImpl;

public class CisBmWbgyDaoImpl extends BaseDaoImpl implements CisBmWbgyDaoPlus{
	
	public Page<Map<String, Object>> getWbgyHouseHolder(Map<String, SearchFilter> conditions, Pageable pageable){
		...
		String sqlString = " SELECT "
				    ...
				    +" FROM "
				        ...
				        +" right JOIN CIS_BM_WBGY l ON l.HOUSEHOLDER_ID = h.HOUSEHOLDER_ID "
				    +" where  h.del_sign <> 'Y' " ;
