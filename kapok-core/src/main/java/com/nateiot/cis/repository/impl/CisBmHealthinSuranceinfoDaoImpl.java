...
import com.nateiot.cis.repository.CisBmHealthinSuranceinfoDaoPlus;
...
public class CisBmHealthinSuranceinfoDaoImpl extends BaseDaoImpl  implements CisBmHealthinSuranceinfoDaoPlus  {
    ...
    public Page<Map<String, Object>> searchHolderHealthInsurance(Map<String, SearchFilter> conditions, Pageable pageable){
        ...
        String sqlString = " SELECT "
                ...
                " h.del_sign <> 'Y' "
                + " AND " +
                " EXISTS(SELECT 1 FROM CIS_BM_HEALTHIN_SURANCEINFO s WHERE s.HOUSEHOLDER_ID = h.HOUSEHOLDER_ID )  " ;
