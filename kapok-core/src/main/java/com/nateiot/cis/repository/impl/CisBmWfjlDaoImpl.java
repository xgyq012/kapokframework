...
import com.nateiot.cis.repository.CisBmWfjlDaoPlus;
import com.nateiot.core.common.persistence.SearchFilter;
import com.nateiot.core.repository.impl.BaseDaoImpl;

public class CisBmWfjlDaoImpl extends BaseDaoImpl implements CisBmWfjlDaoPlus{
		
	public Page<Map<String, Object>> getWfqsnInfoHouseHolder(Map<String, SearchFilter> conditions, Pageable pageable){
		...
		String sqlString = " SELECT "
				    ...
				    +" FROM "
				        ...
				        +" right JOIN CIS_BM_WFJL l ON l.HOUSEHOLDER_ID = h.HOUSEHOLDER_ID "
				    +" where  h.del_sign <> 'Y' " ;
