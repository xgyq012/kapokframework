...
import com.nateiot.cis.repository.CisBmLeftoverChildrenDaoPlus;
import com.nateiot.core.common.persistence.SearchFilter;
import com.nateiot.core.repository.impl.BaseDaoImpl;

public class CisBmLeftoverChildrenDaoImpl extends BaseDaoImpl implements CisBmLeftoverChildrenDaoPlus {

	public Page<Map<String, Object>> getLeftoverChildrenHouseHolder(Map<String, SearchFilter> conditions, Pageable pageable){
		...
		String sqlString = " SELECT "
				    ...
				    +" FROM "
				        ...
				        +" right JOIN CIS_BM_LEFTOVER_CHILDREN l ON l.HOUSEHOLDER_ID = h.HOUSEHOLDER_ID "
				    +" where  h.del_sign <> 'Y' " ;
