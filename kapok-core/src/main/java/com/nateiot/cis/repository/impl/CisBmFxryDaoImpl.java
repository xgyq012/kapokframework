...
import com.nateiot.cis.repository.CisBmFxryDaoPlus;
import com.nateiot.core.common.persistence.SearchFilter;
import com.nateiot.core.repository.impl.BaseDaoImpl;

public class CisBmFxryDaoImpl extends  BaseDaoImpl  implements CisBmFxryDaoPlus {

	@Override
	public Page<Map<String, Object>> getFxryHouseHolder(Map<String, SearchFilter> conditions, Pageable pageable){
		...
		String sqlString = " SELECT "
				    ...
				    +" FROM "
				        ...
				        +" right JOIN CIS_BM_FXRY l ON l.HOUSEHOLDER_ID = h.HOUSEHOLDER_ID "
				    +" where  h.del_sign <> 'Y' " ;
