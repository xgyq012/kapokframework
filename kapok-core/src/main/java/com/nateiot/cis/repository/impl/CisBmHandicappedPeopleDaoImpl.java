...
import com.nateiot.cis.repository.CisBmHandicappedPeopleDaoPlus;
import com.nateiot.core.common.persistence.SearchFilter;
import com.nateiot.core.repository.impl.BaseDaoImpl;

public class CisBmHandicappedPeopleDaoImpl extends BaseDaoImpl implements CisBmHandicappedPeopleDaoPlus {

	@Override
	public Page<Map<String, Object>> getHandicappedPeopleHouseHolder(Map<String, SearchFilter> conditions, Pageable pageable){
		...
		String sqlString = " SELECT "
				    ...
				    +" FROM "
				        ...
				        +" right JOIN CIS_BM_HANDICAPPED_PEOPLE l ON l.HOUSEHOLDER_ID = h.HOUSEHOLDER_ID "
				    +" where  h.del_sign <> 'Y' " ;
