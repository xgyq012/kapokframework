 ...
 */
@Controller
@RequestMapping(value = "/economicOrg")
public class CisBmEconomicOrgController {
	...
	public String list() {
		return "cis/bm/economicOrg/economicOrg";
	}
	...
	public String list2() {
		return "cis/bm/economicOrg/economicOrg-data";
	}
