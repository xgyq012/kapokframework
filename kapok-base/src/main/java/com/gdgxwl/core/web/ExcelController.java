...
public abstract class ExcelController {
	...
	protected HSSFWorkbook getTemplateSource(String url,
		...
		Resource inputFile = new ServletContextResource(request.getSession()
				.getServletContext(), url);
	...
	protected abstract void doExcelExport(HSSFWorkbook workbook,
