...
<div class="content">
	...
	<div id="toolbar" class="dialog-button">
		<a id="confirm" href="javascript:void(0);" class="easyui-linkbutton" onclick="window.actions.confirm($('#orgTree').tree('getSelected'));" data-options="plain:true,iconCls:'icon-ok'">确定</a>
